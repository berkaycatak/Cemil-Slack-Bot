    ...
    def init_db(self):
        ...
        try:
            with self.get_connection() as conn:
                ...
                # Fill The Blank Games (Şarkı Sözü Tamamlama Oyunu)
                cursor.execute("""
                ...
                # Index
                cursor.execute("CREATE INDEX IF NOT EXISTS idx_ftb_user_status ON fill_the_blank_games(user_id, status)")
