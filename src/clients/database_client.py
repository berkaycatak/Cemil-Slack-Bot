    ...
    def _create_indexes(self, cursor):
        ...
        try:
            indexes = [
                ...
                # Glossary indexes
                ("idx_glossary_terms_status", "glossary_terms", "status"),
                ("idx_glossary_terms_category", "glossary_terms", "category"),
                ("idx_glossary_terms_term", "glossary_terms", "term"),
                ("idx_glossary_definitions_term", "glossary_definitions", "term_id"),
                ("idx_daily_term_logs_date", "daily_term_logs", "posted_at"),

                # Quiz indexes
                ("idx_quiz_sessions_user", "quiz_sessions", "user_id"),
                ("idx_quiz_sessions_score", "quiz_sessions", "score"),
                ("idx_quiz_answers_session", "quiz_answers", "session_id"),
            ]
